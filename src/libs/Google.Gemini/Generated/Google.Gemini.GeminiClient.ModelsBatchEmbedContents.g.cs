...
namespace Google.Gemini
{
    public partial class GeminiClient
    {
        ...
        private static readonly global::Google.Gemini.EndPointSecurityRequirement s_ModelsBatchEmbedContentsSecurityRequirement0 =
        ...
        private static readonly global::Google.Gemini.EndPointSecurityRequirement[] s_ModelsBatchEmbedContentsSecurityRequirements =
            new global::Google.Gemini.EndPointSecurityRequirement[]
            {                s_ModelsBatchEmbedContentsSecurityRequirement0,
            };
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Google.Gemini.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Google.Gemini.AutoSDKHttpResponse<global::Google.Gemini.BatchEmbedContentsResponse>> ModelsBatchEmbedContentsAsResponseAsync(
            string modelsId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Google.Gemini.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ModelsBatchEmbedContentsSecurityRequirements,
                operationName: "ModelsBatchEmbedContentsAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Google.Gemini.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Google.Gemini.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ModelsBatchEmbedContents",
                                methodName: "ModelsBatchEmbedContentsAsync",
                                pathTemplate: "$\"/models/{modelsId}:batchEmbedContents\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Google.Gemini.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    return new global::Google.Gemini.AutoSDKHttpResponse<global::Google.Gemini.BatchEmbedContentsResponse>(
