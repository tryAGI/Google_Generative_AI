...
namespace Google.Gemini
{
    public partial class GeminiClient
    {
        ...
        private static readonly global::Google.Gemini.EndPointSecurityRequirement s_ModelsBatchGenerateContentSecurityRequirement0 =
        ...
        private static readonly global::Google.Gemini.EndPointSecurityRequirement[] s_ModelsBatchGenerateContentSecurityRequirements =
            new global::Google.Gemini.EndPointSecurityRequirement[]
            {                s_ModelsBatchGenerateContentSecurityRequirement0,
            };
        partial void PrepareModelsBatchGenerateContentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string modelsId,
            global::Google.Gemini.BatchGenerateContentRequest request);
        partial void PrepareModelsBatchGenerateContentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string modelsId,
            global::Google.Gemini.BatchGenerateContentRequest request);
        partial void ProcessModelsBatchGenerateContentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessModelsBatchGenerateContentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Google.Gemini.Operation> ModelsBatchGenerateContentAsync(
            string modelsId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Google.Gemini.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Google.Gemini.AutoSDKHttpResponse<global::Google.Gemini.Operation>> ModelsBatchGenerateContentAsResponseAsync(
            string modelsId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareModelsBatchGenerateContentArguments(
            ...
            var __authorizations = global::Google.Gemini.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ModelsBatchGenerateContentSecurityRequirements,
                operationName: "ModelsBatchGenerateContentAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Google.Gemini.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Google.Gemini.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ModelsBatchGenerateContent",
                                methodName: "ModelsBatchGenerateContentAsync",
                                pathTemplate: "$\"/models/{modelsId}:batchGenerateContent\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessModelsBatchGenerateContentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Google.Gemini.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessModelsBatchGenerateContentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
        ...
        public async global::System.Threading.Tasks.Task<global::Google.Gemini.Operation> ModelsBatchGenerateContentAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Google.Gemini.BatchGenerateContentRequest
            {
                Batch = batch,
            };

            return await ModelsBatchGenerateContentAsync(
                modelsId: modelsId,
                request: __request,
                requestOptions: requestOptions,
