...
namespace Google.Gemini
{
    public partial class GeminiClient
    {
        ...
        private static readonly global::Google.Gemini.EndPointSecurityRequirement s_TunedModelsPermissionsListSecurityRequirement0 =
        ...
        private static readonly global::Google.Gemini.EndPointSecurityRequirement[] s_TunedModelsPermissionsListSecurityRequirements =
            new global::Google.Gemini.EndPointSecurityRequirement[]
            {                s_TunedModelsPermissionsListSecurityRequirement0,
            };
        ...
        partial void ProcessTunedModelsPermissionsListResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await TunedModelsPermissionsListAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Google.Gemini.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Google.Gemini.AutoSDKHttpResponse<global::Google.Gemini.ListPermissionsResponse>> TunedModelsPermissionsListAsResponseAsync(
            string tunedModelsId,
            int? pageSize = default,
            string? pageToken = default,
            global::Google.Gemini.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Google.Gemini.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TunedModelsPermissionsListSecurityRequirements,
                operationName: "TunedModelsPermissionsListAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Google.Gemini.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Google.Gemini.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TunedModelsPermissionsList",
                                methodName: "TunedModelsPermissionsListAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTunedModelsPermissionsListResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Google.Gemini.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTunedModelsPermissionsListResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Google.Gemini.AutoSDKHttpResponse<global::Google.Gemini.ListPermissionsResponse>(
