...
namespace Google.Gemini
{
    public partial class GeminiClient
    {
        ...
        private static readonly global::Google.Gemini.EndPointSecurityRequirement s_TunedModelsGenerateContentSecurityRequirement0 =
        ...
        private static readonly global::Google.Gemini.EndPointSecurityRequirement[] s_TunedModelsGenerateContentSecurityRequirements =
            new global::Google.Gemini.EndPointSecurityRequirement[]
            {                s_TunedModelsGenerateContentSecurityRequirement0,
            };
        partial void PrepareTunedModelsGenerateContentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string tunedModelsId,
            global::Google.Gemini.GenerateContentRequest request);
        partial void PrepareTunedModelsGenerateContentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string tunedModelsId,
            global::Google.Gemini.GenerateContentRequest request);
        partial void ProcessTunedModelsGenerateContentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTunedModelsGenerateContentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Google.Gemini.GenerateContentResponse> TunedModelsGenerateContentAsync(
            string tunedModelsId,
        ...
        {
            var __response = await TunedModelsGenerateContentAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Google.Gemini.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Google.Gemini.AutoSDKHttpResponse<global::Google.Gemini.GenerateContentResponse>> TunedModelsGenerateContentAsResponseAsync(
            string tunedModelsId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareTunedModelsGenerateContentArguments(
            ...
            var __authorizations = global::Google.Gemini.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_TunedModelsGenerateContentSecurityRequirements,
                operationName: "TunedModelsGenerateContentAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                            ...
                            var __pathBuilder = new global::Google.Gemini.PathBuilder(
                                path: $"/tunedModels/{tunedModelsId}:generateContent",
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareTunedModelsGenerateContentRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Google.Gemini.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Google.Gemini.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "TunedModelsGenerateContent",
                                methodName: "TunedModelsGenerateContentAsync",
                                pathTemplate: "$\"/tunedModels/{tunedModelsId}:generateContent\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessTunedModelsGenerateContentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Google.Gemini.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessTunedModelsGenerateContentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Google.Gemini.AutoSDKHttpResponse<global::Google.Gemini.GenerateContentResponse>(
