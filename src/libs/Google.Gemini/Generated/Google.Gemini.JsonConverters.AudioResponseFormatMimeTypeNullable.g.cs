...
{
    /// <inheritdoc />
    public sealed class AudioResponseFormatMimeTypeNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Google.Gemini.AudioResponseFormatMimeType?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::Google.Gemini.AudioResponseFormatMimeTypeExtensions.ToValueString(value.Value));
            }
        }
    }
}
