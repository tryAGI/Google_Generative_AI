...
namespace Google.Gemini
{
    ...
    {
        /// <summary>
        /// Optional. Specifies the name used to refer to this blob to the model (e.g. "my_blob.png"). Used as the blob reference identifier when `verbalization_mode` is set to `REFERENCE_ONLY`.
        /// </summary>
