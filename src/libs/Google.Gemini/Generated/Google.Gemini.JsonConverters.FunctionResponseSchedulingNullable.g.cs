...
{
    /// <inheritdoc />
    public sealed class FunctionResponseSchedulingNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Google.Gemini.FunctionResponseScheduling?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::Google.Gemini.FunctionResponseSchedulingExtensions.ToValueString(value.Value));
            }
        }
    }
}
