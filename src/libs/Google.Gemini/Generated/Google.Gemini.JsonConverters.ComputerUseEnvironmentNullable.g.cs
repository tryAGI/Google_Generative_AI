...
{
    /// <inheritdoc />
    public sealed class ComputerUseEnvironmentNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Google.Gemini.ComputerUseEnvironment?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::Google.Gemini.ComputerUseEnvironmentExtensions.ToValueString(value.Value));
            }
        }
    }
}
