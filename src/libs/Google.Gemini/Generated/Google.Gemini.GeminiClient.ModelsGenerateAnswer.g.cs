...
namespace Google.Gemini
{
    ...
    {
        partial void PrepareModelsGenerateAnswerArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string modelsId,
            global::Google.Gemini.GenerateAnswerRequest request);
        partial void PrepareModelsGenerateAnswerRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string modelsId,
            global::Google.Gemini.GenerateAnswerRequest request);
        partial void ProcessModelsGenerateAnswerResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessModelsGenerateAnswerResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Google.Gemini.GenerateAnswerResponse> ModelsGenerateAnswerAsync(
            string modelsId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareModelsGenerateAnswerArguments(
                httpClient: HttpClient,
                modelsId: ref modelsId,
                request: request);

            var __pathBuilder = new global::Google.Gemini.PathBuilder(
                path: $"/models/{modelsId}:generateAnswer",
            ...
            PrepareModelsGenerateAnswerRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessModelsGenerateAnswerResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessModelsGenerateAnswerResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
                ...
                try
                {
                    ...
                    return
                        global::Google.Gemini.GenerateAnswerResponse.FromJson(__content, JsonSerializerContext) ??
            ...
            else
            {
                try
                {
                    ...
                    return
                        await global::Google.Gemini.GenerateAnswerResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Google.Gemini.GenerateAnswerResponse> ModelsGenerateAnswerAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Google.Gemini.GenerateAnswerRequest
            {
            ...
            return await ModelsGenerateAnswerAsync(
                modelsId: modelsId,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
