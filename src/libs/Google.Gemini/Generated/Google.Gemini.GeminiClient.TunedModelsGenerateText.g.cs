...
namespace Google.Gemini
{
    ...
    {
        partial void PrepareTunedModelsGenerateTextArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string tunedModelsId,
            global::Google.Gemini.GenerateTextRequest request);
        partial void PrepareTunedModelsGenerateTextRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string tunedModelsId,
            global::Google.Gemini.GenerateTextRequest request);
        partial void ProcessTunedModelsGenerateTextResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessTunedModelsGenerateTextResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Google.Gemini.GenerateTextResponse> TunedModelsGenerateTextAsync(
            string tunedModelsId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareTunedModelsGenerateTextArguments(
                httpClient: HttpClient,
                tunedModelsId: ref tunedModelsId,
                request: request);

            var __pathBuilder = new global::Google.Gemini.PathBuilder(
                path: $"/tunedModels/{tunedModelsId}:generateText",
            ...
            PrepareTunedModelsGenerateTextRequest(
                httpClient: HttpClient,
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessTunedModelsGenerateTextResponse(
                httpClient: HttpClient,
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessTunedModelsGenerateTextResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await TunedModelsGenerateTextAsync(
                tunedModelsId: tunedModelsId,
                request: __request,
                cancellationToken: cancellationToken).ConfigureAwait(false);
        }
