...
namespace Google.Gemini
{
    public partial class GeminiClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::Google.Gemini.Environment> EnvironmentsGetAsync(
            string id,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Google.Gemini.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Google.Gemini.AutoSDKHttpResponse<global::Google.Gemini.Environment>> EnvironmentsGetAsResponseAsync(
            string id,
            global::Google.Gemini.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Google.Gemini.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Google.Gemini.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                pathTemplate: "$\"/environments/{id}:get\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                    ...
                    await global::Google.Gemini.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Google.Gemini.Environment.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Google.Gemini.AutoSDKHttpResponse<global::Google.Gemini.Environment>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Google.Gemini.Environment.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
