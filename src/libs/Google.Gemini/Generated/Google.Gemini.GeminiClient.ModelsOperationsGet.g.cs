...
namespace Google.Gemini
{
    public partial class GeminiClient
    {
        ...
        private static readonly global::Google.Gemini.EndPointSecurityRequirement s_ModelsOperationsGetSecurityRequirement0 =
        ...
        private static readonly global::Google.Gemini.EndPointSecurityRequirement[] s_ModelsOperationsGetSecurityRequirements =
            new global::Google.Gemini.EndPointSecurityRequirement[]
            {                s_ModelsOperationsGetSecurityRequirement0,
            };
        ...
        partial void ProcessModelsOperationsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Google.Gemini.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Google.Gemini.AutoSDKHttpResponse<global::Google.Gemini.Operation>> ModelsOperationsGetAsResponseAsync(
            string operationsId,
            string modelsId,
            global::Google.Gemini.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Google.Gemini.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ModelsOperationsGetSecurityRequirements,
                operationName: "ModelsOperationsGetAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Google.Gemini.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Google.Gemini.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ModelsOperationsGet",
                                methodName: "ModelsOperationsGetAsync",
                                pathTemplate: "$\"/models/{modelsId}/operations/{operationsId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessModelsOperationsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Google.Gemini.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessModelsOperationsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
