...
{
    /// <inheritdoc />
    public sealed class GenerateContentRequestServiceTierNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Google.Gemini.GenerateContentRequestServiceTier?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::Google.Gemini.GenerateContentRequestServiceTierExtensions.ToValueString(value.Value));
            }
        }
    }
}
