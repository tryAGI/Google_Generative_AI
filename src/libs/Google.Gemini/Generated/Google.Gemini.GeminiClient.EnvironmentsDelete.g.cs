...
namespace Google.Gemini
{
    public partial class GeminiClient
    {
        ...
        private static readonly global::Google.Gemini.EndPointSecurityRequirement s_EnvironmentsDeleteSecurityRequirement0 =
        ...
        private static readonly global::Google.Gemini.EndPointSecurityRequirement[] s_EnvironmentsDeleteSecurityRequirements =
            new global::Google.Gemini.EndPointSecurityRequirement[]
            {                s_EnvironmentsDeleteSecurityRequirement0,
            };
        partial void PrepareEnvironmentsDeleteArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string environmentsId);
        partial void PrepareEnvironmentsDeleteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string environmentsId);
        partial void ProcessEnvironmentsDeleteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessEnvironmentsDeleteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Google.Gemini.Empty> EnvironmentsDeleteAsync(
            string environmentsId,
            global::Google.Gemini.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await EnvironmentsDeleteAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Google.Gemini.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Google.Gemini.AutoSDKHttpResponse<global::Google.Gemini.Empty>> EnvironmentsDeleteAsResponseAsync(
            string environmentsId,
            global::Google.Gemini.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareEnvironmentsDeleteArguments(
            ...
            var __authorizations = global::Google.Gemini.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_EnvironmentsDeleteSecurityRequirements,
                operationName: "EnvironmentsDeleteAsync");
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareEnvironmentsDeleteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Google.Gemini.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Google.Gemini.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "EnvironmentsDeleteAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessEnvironmentsDeleteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Google.Gemini.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessEnvironmentsDeleteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Google.Gemini.AutoSDKHttpResponse<global::Google.Gemini.Empty>(
