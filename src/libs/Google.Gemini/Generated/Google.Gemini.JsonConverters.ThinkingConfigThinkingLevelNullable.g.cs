...
{
    /// <inheritdoc />
    public sealed class ThinkingConfigThinkingLevelNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Google.Gemini.ThinkingConfigThinkingLevel?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::Google.Gemini.ThinkingConfigThinkingLevelExtensions.ToValueString(value.Value));
            }
        }
    }
}
