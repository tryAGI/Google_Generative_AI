...
{
    /// <inheritdoc />
    public sealed class GenerationConfigMediaResolutionNullableJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Google.Gemini.GenerationConfigMediaResolution?>
    {
        /// <inheritdoc />
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            {
                writer.WriteStringValue(global::Google.Gemini.GenerationConfigMediaResolutionExtensions.ToValueString(value.Value));
            }
        }
    }
}
